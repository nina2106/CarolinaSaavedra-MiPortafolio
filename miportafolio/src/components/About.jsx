...
const About = () => {
  return (
    <div className="relative flex flex-col items-start justify-center h-screen p-8"> {/* Cambiado a items-start para alinear a la izquierda */}
      ...
      <div className="relative z-10 p-6 rounded-lg shadow-lg text-left text-red-600"> {/* Cambiado a text-left y max-w-2xl para limitar el ancho */}
        <h1 className="text-9xl text-red-300 font-bold mb-6">Sobre Mí</h1> {/* Aumenta el tamaño del título */}
