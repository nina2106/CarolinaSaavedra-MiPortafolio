...
const About = () => {
  return (
    <div className="relative flex items-center justify-center min-h-screen p-8">
      ...
      <div className="relative z-10 flex items-center justify-start w-full max-w-7xl bg-black bg-opacity-40 p-8 rounded-lg">
        ...
        <div className="flex-shrink-0 mr-12">
          <img
            src={img4}
            alt="Mi imagen"
            className="w-48 h-48 object-cover rounded-full border-4 border-green-400 shadow-xl"
          />
        </div>

        {/* Texto */}
        <div className="text-white max-w-4xl">
          <h1 className="text-5xl text-green-400 text-center font-bold mb-6">
            Sobre Carolina Saavedra
          </h1>
